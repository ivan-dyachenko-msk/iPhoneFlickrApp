...
//    
//    func fetchPhotosFromInteractor(page: Int) {
//        API_WRAPPER.fetchPhotos(urlTo: Constants.photoPopilarURL(page: page), searchText: nil, page: page, closure: {(error, totalPages, photos) in
//            if let photo = photos {
//                self.presenter.providedPhotos(photo, totalPages: totalPages  )
//            } else if let error = error {
//                print("Error fetchPhotosFromInteractor - \(error)")
//            }
//        })
//    }
//    
